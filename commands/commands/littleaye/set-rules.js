...
const { color } = require('@root/config-littleaye.json')
...
module.exports = {
    ...
    callback: (message, arguments, text, client, cache) => {
        ...
        embed7.setColor(color.info)
            ...
            .setDescription(`If you feel that you were punished erroneously or the decision to punish you was made without proper context, please send a direct message to <@&817690172695117845>. The appeal should contain the following, in as much detail as you find appropriate:
