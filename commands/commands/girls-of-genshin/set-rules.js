...
const { color } = require('@root/config-girls-of-genshin.json')
...
module.exports = {
    ...
    callback: (message, arguments, text, client, cache) => {
        ...
        embed7.setColor(color.info)
            ...
            .setDescription(`If you feel that you were punished erroneously or the decision to punish you was made without proper context, please send a direct message to <@&819520426950656051>. The appeal should contain the following, in as much detail as you find appropriate:
